...
class COCOeval:
    ...
    def summarize(self):
        ...
        def _summarizeDets():
            ...
            print("\n*****************************************")
            for name, index in zip(print_name, print_j):
                print(f"[{name}]:\t\t {stats[index]}")
            print("*****************************************\n")
...
class Params:
    ...
    def setDetParams(self):
        ...
        self.areaRng = [[0 ** 2, 1e5 ** 2], [0 ** 2, 24 ** 2], [24 ** 2, 56 ** 2], [56 ** 2, 128 ** 2], [128 ** 2, 1e5 ** 2], [0 ** 2, 32 ** 2],  [32 ** 2, 96 ** 2], [96 ** 2, 1e5 ** 2]]
        self.areaRngLbl = ['all', '0-24', '24-56', '56-128','128-', "small", "medium", 'large']
        self.useCats = 1
