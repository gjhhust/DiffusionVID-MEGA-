...
from mega_core.data.datasets.evaluation.coco.coco_eval import do_coco_evaluation

def do_vid_evaluation(dataset, predictions, output_folder, box_only, motion_specific, logger):

    if hasattr(dataset,"coco_json"):
        ...
        do_coco_evaluation(coco_dataset, predictions, box_only=False,output_folder=output_folder,iou_types=["bbox"],expected_results=None,expected_results_sigma_tol=None)
